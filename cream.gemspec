...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".document",
     ...
     "spec/generators/cream/config/default_args_spec.rb",
     "spec/generators/cream/config/init_devise.rb",
     "spec/generators/cream/config/roles_spec.rb",
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<devise-links>, ["~> 0.1.0"])
      s.add_runtime_dependency(%q<cancan-rest-links>, ["~> 0.1.0"])
      s.add_runtime_dependency(%q<cancan-permits>, ["~> 0.1.0"])
      s.add_runtime_dependency(%q<devise>, ["~> 1.1.2"])
      s.add_runtime_dependency(%q<cancan>, ["~> 1.3.4"])
      s.add_runtime_dependency(%q<rails>, ["~> 3.0.0"])
      s.add_runtime_dependency(%q<rails3_artifactor>, ["~> 0.2.3"])
      s.add_runtime_dependency(%q<logging_assist>, ["~> 0.1.2"])
      s.add_runtime_dependency(%q<r3_plugin_toolbox>, ["~> 0.3.6"])
      s.add_runtime_dependency(%q<sugar-high>, ["~> 0.2.9"])
    else
      ...
      s.add_dependency(%q<devise-links>, ["~> 0.1.0"])
      s.add_dependency(%q<cancan-rest-links>, ["~> 0.1.0"])
      s.add_dependency(%q<cancan-permits>, ["~> 0.1.0"])
      s.add_dependency(%q<devise>, ["~> 1.1.2"])
      s.add_dependency(%q<cancan>, ["~> 1.3.4"])
      s.add_dependency(%q<rails>, ["~> 3.0.0"])
      s.add_dependency(%q<rails3_artifactor>, ["~> 0.2.3"])
      s.add_dependency(%q<logging_assist>, ["~> 0.1.2"])
      s.add_dependency(%q<r3_plugin_toolbox>, ["~> 0.3.6"])
      s.add_dependency(%q<sugar-high>, ["~> 0.2.9"])
    end
  else
    s.add_dependency(%q<rspec>, ["~> 2.0.0.beta.22"])
    s.add_dependency(%q<generator-spec>, ["~> 0.6.4"])
