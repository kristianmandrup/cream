...
begin
  ...
  Jeweler::Tasks.new do |gem|
    ...
    # gem.add_development_dependency "rspec-action_view", ">= 0.3.5"
    # gem.add_development_dependency "rails-app-spec",    ">= 0.3.2"
    ...
    gem.add_dependency "devise-links",      ">= 0.2.3"
    gem.add_dependency "cancan-rest-links", ">= 0.2.3"
    ...
    gem.add_dependency "r3_plugin_toolbox", ">= 0.4.1"
